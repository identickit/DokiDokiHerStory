...
define audio.wn8 = "mod_assets/bgm/warpedneweight.ogg" # Her Theme (Static)
define audio.wn9 = "mod_assets/bgm/warpednewnine.ogg" # Broken Club! - variant for Prologue and Act I (more happy moments)
...
define audio.wn20 = "mod_assets/bgm/warpednewtwentyv.ogg" # Deep Breaths
define audio.wnb = "mod_assets/bgm/warpednewboss.ogg" # Dreams of Silver and Lavender
define audio.wnw = "mod_assets/bgm/yuri-wrongopt.ogg" # Yuri-WrongOPT
define audio.wnf = "mod_assets/bgm/nat-silverforce.ogg" # Nat-SilverForce
...
define audio.wok = "mod_assets/bgm/ohayoukotonohav.ogg" # Ohayou, Kotonoha.
define audio.wtm = "mod_assets/bgm/warpedtoomuch.ogg" # unnamed track - not a part of OST but used for when Yuri screams in Her Story
define audio.wnx = "mod_assets/bgm/xiswendepraw.ogg" # Her Theme (Reversed) [also known as emehT reH]
define audio.wah = "mod_assets/bgm/warpednewhopev.ogg" # There's Always Hope
define audio.wnn = "mod_assets/bgm/warpednewneverv.ogg" # There's Never Hope

define audio.te01 = "mod_assets/bgm/tester01v.ogg" #first clip
define audio.te02 = "mod_assets/bgm/tester02v.ogg" #second clip
...
#define audio.tkoto = "mod_assets/bgm/" #Okay Everyone! (Her)
...
image bg club_day2: # Glitched Club BG
    ...
    choice:
        "bg/club-skill.png"
image bg koto_bedroom = "mod_assets/bg/koto_bedroom.png" # Kotonoha's Bedroom
image bg koto_livingroom = "mod_assets/bg/koto_livingroom.png" # Kotonoha's Living Room
